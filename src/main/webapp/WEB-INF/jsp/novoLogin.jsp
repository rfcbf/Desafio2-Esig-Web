                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="login-panel panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form role="form" action="/login/novaConta" method="post" id="FormSenha" name="FormSenha">


                                <fieldset>
                                    <input hidden="hidden" name="tipo" value="U">
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Nome Completo" name="nome" type="text" autofocus required="required">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Repita a Senha" name="senha2" id="senha2" type="password" value="" required="required">
                                    </div>
                                    ...
                                    <button type="button" onclick="validarSenha()" class="btn btn-lg btn-primary btn-block">Criar</button>
                                    <button type="reset" class="btn btn-block btn-lg btn-danger">Limpar</button>
